...
program = ""
files = [path + "rom.lua", path + "flag.lua", path + "interrupt.lua", path + "header.lua", path + "bitwise.lua", path + "graphics.lua", path + "dispatcher.lua", path + "helperFunctions.lua", path + "memory.lua", path + "opcodes.lua"]
